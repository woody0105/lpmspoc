...
int decode(struct decode_thread *h,
  input_params *inp, output_results *decoded_results, dframe_buffer *dframe_buf, struct input_ctx *ictx)
{
  int ret = 0, i = 0;
...
{
  int ret = 0;
  struct decode_thread *h = inp->dec_handle;
